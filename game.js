...
var Player = function () {
    ...
    this.draw = function () {
        ...
        this.rSpeed += rotationInput * 0.05;
...
function updateBackground() {
    // Calculate the index based on distance traveled
    let newIndex = Math.floor(distance / 40) % backgrounds.length;
...
function loop() {
    speed -= (speed - powerInput) * 0.00002;
    t += 10 * speed;

    distance += speed * 0.1;
    caloriesBurnt = distance * 0.05;
